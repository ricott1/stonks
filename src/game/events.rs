...
pub enum NightEvent {
    ...
    MarketCrash,
    UltraVision,
    CharacterAssassination { agent_id: AgentId, username: String },
    AGoodOffer,
    LuckyNight,
...
impl NightEvent {
    ...
    pub fn unlock_condition(
        ...
        match self {
            Self::War => Box::new(move |agent, stonks| {
                let war_stonks = stonks
                    .iter()
    ...
    pub fn action(&self) -> AgentAction {
        match self {
            ...
            Self::CharacterAssassination { agent_id, .. } => AgentAction::CrashAgentStonks {
                agent_id: *agent_id,
            },
